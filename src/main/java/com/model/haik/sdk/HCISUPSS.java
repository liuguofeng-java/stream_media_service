...
public interface HCISUPSS extends StdCallLibrary {
	...
	HCISUPSS INSTANCE = (HCISUPSS) Native.loadLibrary(StreamMediaConfig.pathDll + "HCISUPSS.dll", HCISUPSS.class);
	/***宏定义***/
	//常量
	 ...
	 * @return
	 */
	boolean NET_ESS_StopListen(NativeLong lListenHandle);
	 ...
	 * @return
	 */
	NativeLong NET_ESS_CreateClient(NET_EHOME_SS_CLIENT_PARAM pClientParam);
	 ...
	 * @return
	 */
	boolean NET_ESS_ClientSetTimeout(NativeLong lHandle, int dwSendTimeout, int dwRecvTimeout);
	 ...
	 * @return
	 */
	boolean NET_ESS_ClientSetParam(NativeLong lHandle, String strParamName, String strParamVal);
	 ...
	 * @return
	 */
	boolean NET_ESS_ClientDoUpload(NativeLong lHandle, byte[] strUrl, int dwUrlLen);
	 ...
	 * @return
	 */
	boolean NET_ESS_ClientDoDownload(NativeLong lHandle, String strUrl, PointerByReference pFileContent, IntByReference dwContentLen);
	 ...
	 * @return
	 */
	boolean NET_ESS_DestroyClient(NativeLong lHandle);
